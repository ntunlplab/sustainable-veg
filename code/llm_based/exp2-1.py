...
def sasb_stringify(metrics_data):
    ...
    for metric in metrics_data:
        ...
        # metric_str = f"- Code: {code}; Description: {description}."
...
def process(data, args, client):
    ...
    for item in tqdm(data):
        ...
        # sasb_metrics = item["sasb_report"].replace(".pdf", "")

        # metric_path = f"{args.metrics}/{sasb_metrics}.jsonl"
...
def main():
    ...
    train_predictions, train_predictions_format, raw_responses = process(train_data, args, client)
    ...
    with open("train_predictions_4o-mini_v2-1.json", 'w') as f:
        json.dump(train_predictions, f, indent=4)
    with open("train_predictions_format_4o-mini_v2-1.json", 'w') as f:
        json.dump(train_predictions_format, f, indent=4)
    with open("train_raw_responses_4o-mini_v2-1.json", 'w') as f:
        json.dump(raw_responses, f, indent=4)
    
    # with open("test_predictions_team16_4o-mini_v2-1.json", 'w') as f:
    #     json.dump(test_predictions, f, indent=4)
    # with open("test_predictions_format_team16_4o-mini_v2-1.json", 'w') as f:
    #     json.dump(test_predictions_format, f, indent=4)
    # with open("test_raw_responses_team16_4o-mini_v2-1.json", 'w') as f:
    #     json.dump(raw_responses, f, indent=4)
